...
export function PromoCodeBadge({ code, discountPercent, className = '', size = 'default' }: PromoCodeBadgeProps) {
  ...
  return (
    <div className={`flex w-full max-w-full items-center gap-3 rounded-lg bg-neutral-50 p-2 text-sm text-neutral-700 dark:bg-white/[0.04] dark:text-neutral-200 ${className}`}>
